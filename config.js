...
module.exports = {
    ...
    ANTI_FILTER: process.env.REMOVE_FILTER === undefined ? 'fucker' : process.env.REMOVE_FILTER,
    ...
    ALIVEBUTTON: process.env.ALIVE_BUTTON === undefined ? 'broken' : process.env.ALIVE_BUTTON,
    ALIVBUTTON: process.env.ALIV_BUTTON === undefined ? 'Jackz' : process.env.ALIV_BUTTON,
