...
module.exports = {
    ...
    ALIVEBUTTON: process.env.ALIVE_BUTTON === undefined ? 'broken' : process.env.ALIVEBUTTON,
    ALIVBUTTON: process.env.ALIV_BUTTON === undefined ? 'Jackz' : process.env.ALIVBUTTON,
